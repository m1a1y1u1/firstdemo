 ...
 */
@Endpoint(id = "api-doc")
public class ApiDocMappingsEndpoint {

	private final Collection<ApiDocMappingDescriptionProvider> descriptionProviders;

	private final ApplicationContext context;

	public ApiDocMappingsEndpoint(Collection<ApiDocMappingDescriptionProvider> descriptionProviders, ApplicationContext context) {
